    ...
    render() {
        ...
        return(
            <div>
                ...
                {(patient.appointments.length > 0 ) && this.state.portalOpen ? patient.appointments.map(appointment => <AppointmentCard appointment={appointment} toggleModal={this.toggleModal} setSelectedAppointment={this.setSelectedAppointment}/>) : null}
