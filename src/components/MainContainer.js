    ...
    render() {
        ...
        return(
            <div>
                ...
                {(patient.appointments.length > 0 ) && this.state.portalOpen ? patient.appointments.map(appointment => <AppointmentCard appointment={appointment} key={appointment.id} toggleModal={this.toggleModal} setSelectedAppointment={this.setSelectedAppointment} openEditForm={this.openEditForm}/>) : <div className="main-container">You have no appointments scheduled at this time.</div>}
